...
# Updated 12/22/98 by www.bright-productions.com for use with intellipay.com
#
##############################################################################
# Set Variables

$dbfile = "../database/downloadallcc.db";
$mdbfile = "../database/mailing.db";
$cgiurl = "http://www.quickcalc.com/website/cgi-bin/downloadallcc.cgi";
...
print DBFILE "\"$country\"|\"$login\"|\"$amount\"|\"$custid\"|\"$description\"|\"$name\"|\"$day\"|\"$time\"|\"$$zone\"|\"$address\"|\"$city\"|\"$state\"|\"$zip\"|\"$email\"|\"$user2\"|\"$user1\"\n";
...
if ($mlist eq 'ON')
	...
	open (MDBFILE, ">>$mdbfile") || die "Can't Open $mdbfile: $!\n";
	 ...
	 print MDBFILE
"\"$country\"|\"$login\"|\"$amount\"|\"$custid\"|\"$description\"|\"$name\"|\"$day\"|\"$time\"|\"$$zone\"|\"$address\"|\"$city\"|\"$state\"|\"$zip\"|\"$email\"|\"$user2\"|\"$user1\"\n";
...
# Send to Chris Tong
   ...
   print MAIL "Subject:  download  all  from intellipay request\n\n";
   print MAIL "------------------------------------------------------\n";
   ...
   print MAIL "COMMENTS: $user2 \n";
   print MAIL "MLIST: $user1 \n";
...
VLINK=\"#FF0000\" ALINK=\"#0080FF\" BACKGROUND=\"http://www.quickcalc.com/quickback.gif\"><font face=\"arial,helvetica\">\n";
   ...
   print "<CENTER><INPUT type=submit value=\"Download and Send to Friends Free\"></CENTER></FORM>\n";
   print "<center>OR</center><br>\n"; 
   print "To only download your QuickCalc Calculator and not send calculators to friends: <form><CENTER><input type=button name=B1 value=\"Download Only\"  onClick=\"top.location='http://www.quickcalc.com/website/cgi-bin/qcv1.exe'\"></CENTER><br><br>\n";
 print "</form><br><br>\n";  
