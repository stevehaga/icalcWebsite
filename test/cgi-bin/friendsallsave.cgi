...
print "<CENTER><center><b><BR>\n";
   print "<BR>Order over a secure server: <form><a href=\"https://order.kagi.com/?QGU\"><CENTER><input type=button name=B1 value=\"Order on Secure Server\"  onClick=\"top.location='https://order.kagi.com/?QGU'\"></CENTER></a><br><br>\n";
 print "<center>OR</center><br>\n"; 
   print "Order over a non-secure server: <BR><BR><form><a href=\"http://order.kagi.com/?QGU\"><CENTER><input type=button name=B1 value=\"Order on Non-Secure Server\"  onClick=\"top.location='http://order.kagi.com/?QGU'\"></CENTER></a></form><br><br>\n";  
   print "</center>\n";
   print "</TD></TR></TABLE>\n";
   # Print End of HTML
...
# took out above line so first and last name are not required
 if (($emailr ne ""))
   ...
   print MAIL "       http://www.quickcalc.com/website/intro/downloadg.html\n\n"; 
   print MAIL "------------------------------------------------------------------\n";   
