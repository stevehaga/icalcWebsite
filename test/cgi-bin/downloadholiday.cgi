...
$dbfile = "../database/downloadholiday.db";
$mdbfile = "../database/mailing.db";
$cgiurl = "http://www.quickcalc.com/cgi-bin/downloadholiday.cgi";
...
$ccdatem=$FORM{'ccdatem'};
$ccdatey=$FORM{'ccdatey'};
...
&no_cc unless $FORM{'ccdatem'};
&no_cc unless $FORM{'ccdatey'};
...
print DBFILE "\"$email\"|\"$lname\"|\"$fname\"|\"$day\"\|\"$time\"|\"$$zone\"|\"$mlist\"|\"$cctype\"|\"$ccnumber\"|\"$ccdatem\"|\"$ccdatey\"|\"$comments\"\n";
...
if ($mlist eq 'ON')
	...
	open (MDBFILE, ">>$mdbfile") || die "Can't Open $mdbfile: $!\n";
	 ...
	 print MDBFILE "\"$email\"|\"$lname\"|\"$fname\"|\"$day\"\|\"$time\"|\"$$zone\"|\"$mlist\"|\"$cctype\"|\"$ccnumber\"|\"$ccdatem\"|\"$ccdatey\"|\"$comments\"\n";
...
# Send to Chris Tong
   ...
   print MAIL "CCDATEMONTH: $ccdatem\n";
   print MAIL "CCDATEYEAR: $ccdatey\n";
...
<html>
<head><title>QuickCalc: QuickFriends Program</title></head>
<BODY TEXT=\"#000080\"  BACKGROUND=\"http://www.quickcalc.com/quickback.gif\" BGCOLOR=\"#FFFFFF\" LINK=\"#0000EE\" 
VLINK=\"#FF0000\" ALINK=\"#0080FF\"><font face=\"arial,helvetica\">


<CENTER>

<P><IMG SRC=\"http://www.quickcalc.com/title_w_new1_sm.gif\" ALT=\"QuickCalc\" HEIGHT=76 WIDTH=285><BR>
...
<font color=\"#FF0000\">Please</font> fill in up to  
</FONT><FONT COLOR=\"#FF0000\">5</FONT><FONT COLOR=\"#000080\">
friends e-mail addresses.  </FONT></FONT></B><BR><B><FONT FACE=\"arial\"><FONT COLOR=\"#000080\">An e-mail 
postcard, will be sent with instructions for downloading their gift calculator.</FONT></FONT></B></P>
...
<FORM method=POST action=\"../cgi-bin/friendsholiday.cgi\"><FONT FACE=\"arial\"><FONT SIZE=+1><FONT COLOR=\"#FF0000\">
