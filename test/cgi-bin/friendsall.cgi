...
print "<CENTER><center><b><BR>\n";
   print "<BR><form><CENTER><input type=button name=B1 value=\"Download\"  onClick=\"top.location='http://www.quickcalc.com/website/cgi-bin/qcv1.exe'\"></CENTER><br><br>\n";
 print "</form><br><br>\n";  
   print "</TD></TR></TABLE>\n";
   # Print End of HTML
...
# took out above line so first and last name are not required
 if (($emailr ne ""))
   ...
   print MAIL "       http://www.quickcalc.com/indexfriends.shtml\n\n"; 
print MAIL "Check out our great Holiday Special!\n";
   print MAIL "------------------------------------------------------------------\n";   
